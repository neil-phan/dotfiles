...
./manage-translations.sh update -l ja_JP
...
./translation-manager.py --language ja_JP
...
./translation-cleaner.py --sync --source-lang ja_JP
...
cp .config/quickshell/translations/ja_JP.json.backup .config/quickshell/translations/ja_JP.json
