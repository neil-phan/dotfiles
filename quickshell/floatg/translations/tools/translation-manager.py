...
def main():
    ...
    parser.add_argument("--source-dir", "-s", 
                       default=".config/quickshell/floatg",
                       help="Source code directory (default: .config/quickshell/floatg)")
    parser.add_argument("--language", "-l", 
                       help="Specify language code to process (e.g., ja_JP)")
        ...
        if args.language:
            ...
            if not available_languages:
                if manager.yes_mode:
                    ...
                    return
                lang_input = input("Enter language code to create (e.g.: ja_JP): ").strip()
                if lang_input:
