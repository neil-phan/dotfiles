    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject apps: JsonObject {
                ...
                property string changePassword: "ghostty --wait-after-command=true -e fish -i -c 'passwd'"
                property string network: "kcmshell6 kcm_networkmanagement"
                property string manageUser: "kcmshell6 kcm_users"
                property string networkEthernet: "kcmshell6 kcm_networkmanagement"
                property string taskManager: "plasma-systemmonitor --page-name Processes"
                property string terminal: "ghostty" // Base terminal executable for shell actions
                property string update: "ghostty --wait-after-command=true -e fish -i -c 'pkexec pacman -Syu'"
            ...
            property JsonObject bar: JsonObject {
                ...
                property string topLeftIcon: "spark" // Options: "distro" or any icon name in ~/.config/quickshell/floatg/assets/icons
            ...
            property JsonObject language: JsonObject {
                property string ui: "auto" // UI language. "auto" for system locale, or specific language code like "en_US", "ja_JP"
            }
            ...
            property JsonObject workSafety: JsonObject {
                ...
                property JsonObject triggerCondition: JsonObject {
                    ...
                    property list<string> fileKeywords: ["spoiler"]
