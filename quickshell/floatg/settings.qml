...
ApplicationWindow {
    ...
    visible: true
    onClosing: Qt.quit()
    title: "floating-garden Settings"
            ...
            Item {
                ...
                NavigationRail { // Window content with navigation rail and content pane
                    ...
                    FloatingActionButton {
                        ...
                        downAction: () => {
                            Qt.openUrlExternally(`${Directories.config}/floating-garden/config.json`);
                        }
                        altAction: () => {
                            Quickshell.clipboardText = CF.FileUtils.trimFileProtocol(`${Directories.config}/floating-garden/config.json`);
                            fab.justCopied = true;
